...
| method | endpoint | 설명 | 권한 |
| --- | --- | --- | --- |
| GET | /api/booths | 부스 목록 조회 (day, type 필터) | 모두 |
| GET | /api/booths/:boothId  | 부스 상세 정보 조회 | 모두 |
...
| method | endpoint | 설명 | 권한 |
| --- | --- | --- | --- |
| GET | /api/booths/:boothId/menus | 특정 부스의 메뉴 목록 조회 | 모두 |
...
| method | endpoint | 설명 | 권한 |
| --- | --- | --- | --- |
| GET | /api/locations | 배치도 전체 조회 (day, type 필터) | 모두 |
