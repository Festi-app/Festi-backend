...
public class MenuController {
    ...
    @Operation(summary = "Create menu item", description = "Creates a new menu item for the booth. Only allowed for NIGHT booths.")
    @ApiResponses({
            @ApiResponse(responseCode = "201", description = "Menu item created"),
            @ApiResponse(responseCode = "400", description = "Invalid request body or booth is not a NIGHT booth"),
            @ApiResponse(responseCode = "401", description = "Authentication is required"),
    ...
    @Operation(summary = "Update menu item", description = "Updates an existing menu item. Only allowed for NIGHT booths.")
    @ApiResponses({
