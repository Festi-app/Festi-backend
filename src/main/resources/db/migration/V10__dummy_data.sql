...
INSERT INTO users (festival_id, id, name, phone, password_hash, role, created_at, updated_at) VALUES
  ('00000000-0000-0000-0000-000000000001', 'admin', '총관리자', '010-0000-0000', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'FESTIVAL_ADMIN', NOW(), NOW());

-- Step 3: 사용자 - 일반 사용자 (10명)
INSERT INTO users (festival_id, id, name, phone, password_hash, role, created_at, updated_at) VALUES
  ('00000000-0000-0000-0000-000000000001', 'user01', '김민수', '010-1001-0001', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'USER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'user02', '이지은', '010-1001-0002', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'USER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'user03', '박준호', '010-1001-0003', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'USER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'user04', '최유나', '010-1001-0004', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'USER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'user05', '정도현', '010-1001-0005', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'USER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'user06', '강서연', '010-1001-0006', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'USER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'user07', '윤재원', '010-1001-0007', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'USER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'user08', '임소희', '010-1001-0008', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'USER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'user09', '한동현', '010-1001-0009', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'USER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'user10', '오미래', '010-1001-0010', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'USER', NOW(), NOW());

-- Step 3: 사용자 - 주간 부스 관리자 (20명)
INSERT INTO users (festival_id, id, name, phone, password_hash, role, created_at, updated_at) VALUES
  ('00000000-0000-0000-0000-000000000001', 'day01', '김현우', '010-2001-0001', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'day02', '이수아', '010-2001-0002', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'day03', '박지민', '010-2001-0003', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'day04', '최재훈', '010-2001-0004', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'day05', '정예은', '010-2001-0005', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'day06', '강민준', '010-2001-0006', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'day07', '윤하은', '010-2001-0007', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'day08', '임세준', '010-2001-0008', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'day09', '한지수', '010-2001-0009', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'day10', '오준혁', '010-2001-0010', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'day11', '서아린', '010-2001-0011', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'day12', '신동혁', '010-2001-0012', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'day13', '권나연', '010-2001-0013', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'day14', '배민서', '010-2001-0014', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'day15', '조현석', '010-2001-0015', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'day16', '유지원', '010-2001-0016', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'day17', '문채원', '010-2001-0017', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'day18', '노태준', '010-2001-0018', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'day19', '하지혜', '010-2001-0019', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'day20', '마준서', '010-2001-0020', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW());

-- Step 3: 사용자 - 야간 부스 관리자 (15명)
INSERT INTO users (festival_id, id, name, phone, password_hash, role, created_at, updated_at) VALUES
  ('00000000-0000-0000-0000-000000000001', 'night01', '김태양', '010-3001-0001', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'night02', '이소율', '010-3001-0002', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'night03', '박정민', '010-3001-0003', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'night04', '최가은', '010-3001-0004', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'night05', '정시훈', '010-3001-0005', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'night06', '강은서', '010-3001-0006', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'night07', '윤민혁', '010-3001-0007', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'night08', '임지안', '010-3001-0008', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'night09', '한준영', '010-3001-0009', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'night10', '오서원', '010-3001-0010', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'night11', '서지후', '010-3001-0011', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'night12', '신유진', '010-3001-0012', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'night13', '권민준', '010-3001-0013', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'night14', '배나연', '010-3001-0014', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'night15', '조하린', '010-3001-0015', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW());

-- Step 3: 사용자 - 푸드트럭 관리자 (6명)
INSERT INTO users (festival_id, id, name, phone, password_hash, role, created_at, updated_at) VALUES
  ('00000000-0000-0000-0000-000000000001', 'ft01', '이재원', '010-4001-0001', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'ft02', '김수현', '010-4001-0002', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'ft03', '박도연', '010-4001-0003', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'ft04', '최민재', '010-4001-0004', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'ft05', '정하윤', '010-4001-0005', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000001', 'ft06', '강지수', '010-4001-0006', '$2b$10$aAvQf17HQMuGDYbzhV0UauQuZaaQkPPQXuUhGeIb83TjnyYnoWAcy', 'BOOTH_MANAGER', NOW(), NOW());
...
-- Step 5: 야간 부스 (15개) — 01~05: 바로입장 / 06~10: 웨이팅가능 / 11~15: 웨이팅중
INSERT INTO booths (id, festival_id, manager_id, name, category, type, description, operating_hours, image_url, is_waiting_open, created_at, updated_at) VALUES
...
-- Step 10: 즐겨찾기 (user01~05 각 3개, 총 15개)
